...
export default function FundTransferClientPage({ initialData }: { initialData: any[] }) {
            ...
            <Card>
                ...
                <CardContent>
                    <Tabs defaultValue="credit">
                        <TabsList>
                            <TabsTrigger value="credit">Fund Credit</TabsTrigger>
                            <TabsTrigger value="debit">Fund Debit</TabsTrigger>
                        </TabsList>
