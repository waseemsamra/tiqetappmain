    ...
    <div className="space-y-6">
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
            <Link href={`/agent/${agentNameForUrl}`} className="flex items-center gap-4 p-4 border rounded-lg hover:bg-muted/50 transition-colors" target="_blank">
             ...
             <Link href="/agent-dashboard/cms/featured-excursions" className="flex items-center gap-4 p-4 border rounded-lg hover:bg-muted/50 transition-colors">
