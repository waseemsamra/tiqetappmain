...
export const AttractionCard = ({ excursion, wishlistButton, rank }: { excursion: Excursion, wishlistButton?: React.ReactNode, rank?: number }) => (
    <div className="rounded-xl shadow-md hover:shadow-lg transition-shadow duration-300 overflow-hidden flex flex-col group h-full bg-white relative border border-gray-200/80">
         {rank && (
             ...
             <div className="p-4 flex flex-col flex-grow">
                 ...
                 <div className="flex items-center justify-between mt-auto pt-4">
                     ...
                     <div className="text-right">
                         ...
                         <p className="font-bold text-lg text-gray-900">{excursion.currency === "EUR" ? "X" : excursion.currency === "USD" ? "$" : excursion.currency === "GBP" ? "£" : excursion.currency}${Number(excursion.price || 0).toFixed(2)}</p>
                     </div>
                 </div>
             </div>
         </Link>
